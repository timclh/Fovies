...
public class LayoutFeedTopCommentBindingImpl extends LayoutFeedTopCommentBinding implements com.mooc.fovies.generated.callback.OnClickListener.Listener {
    ...
    @NonNull
    private final com.mooc.fovies.view.PPImageView mboundView7;
    @NonNull
    ...
    private LayoutFeedTopCommentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            , (com.mooc.fovies.view.PPImageView) bindings[1]
        ...
        this.mboundView7 = (com.mooc.fovies.view.PPImageView) bindings[7];
        ...
        setRootTag(root);
        // listeners
        mCallback6 = new com.mooc.fovies.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.lifeCycleOwner == variableId) {
            ...
            setComment((com.mooc.fovies.model.Comment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setComment(@Nullable com.mooc.fovies.model.Comment Comment) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeComment((com.mooc.fovies.model.Comment) object, fieldId);
            case 1 :
                return onChangeCommentUgc((com.mooc.fovies.model.Ugc) object, fieldId);
            case 2 :
                return onChangeCommentAuthor((com.mooc.fovies.model.User) object, fieldId);
        }
        return false;
    }
    private boolean onChangeComment(com.mooc.fovies.model.Comment Comment, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeCommentUgc(com.mooc.fovies.model.Ugc CommentUgc, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeCommentAuthor(com.mooc.fovies.model.User CommentAuthor, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        com.mooc.fovies.model.Comment comment = mComment;
        ...
        com.mooc.fovies.model.Ugc commentUgc = null;
        ...
        com.mooc.fovies.model.User commentAuthor = null;
        ...
        if ((dirtyFlags & 0x80000L) != 0) {
                ...
                stringConvertConvertFeedUgcCommentUgcLikeCount = com.mooc.fovies.utils.StringConvert.convertFeedUgc(commentUgcLikeCount);
        }
        ...
        if ((dirtyFlags & 0x25L) != 0) {
            ...
            com.mooc.fovies.view.PPImageView.setImageUrl(this.avatar, commentAuthorAvatar, true, (int)0);
        ...
        if ((dirtyFlags & 0x21L) != 0) {
            ...
            com.mooc.fovies.view.PPImageView.setImageUrl(this.mboundView7, commentImageUrl, false, (int)0);
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        com.mooc.fovies.ui.InteractionPresenter.toggleCommentLike(lifeCycleOwner, comment);
    }
    // dirty flag
