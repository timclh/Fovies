...
import com.mooc.fovies.databinding.ActivityFeedDetailTypeImageBindingImpl;
import com.mooc.fovies.databinding.ActivityLayoutCaptureBindingImpl;
import com.mooc.fovies.databinding.ActivityLayoutPreviewBindingImpl;
import com.mooc.fovies.databinding.ActivityLayoutProfileBindingImpl;
import com.mooc.fovies.databinding.ActivityLayoutPublishBindingImpl;
import com.mooc.fovies.databinding.ActivityLayoutTagFeedListBindingImpl;
import com.mooc.fovies.databinding.FragmentMyBindingImpl;
import com.mooc.fovies.databinding.FragmentSofaBindingImpl;
import com.mooc.fovies.databinding.LayoutCommentDialogBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedAuthorBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedCommentListItemBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedDetailBottomInateractionBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedDetailTypeImageHeaderBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedDetailTypeVideoBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedDetailTypeVideoHeaderBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedInteractionBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedTagBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedTextBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedTopCommentBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedTypeCommentBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedTypeImageBindingImpl;
import com.mooc.fovies.databinding.LayoutFeedTypeVideoBindingImpl;
import com.mooc.fovies.databinding.LayoutProfileTabCommentInteractionBindingImpl;
import com.mooc.fovies.databinding.LayoutRefreshViewBindingImpl;
import com.mooc.fovies.databinding.LayoutTagFeedListHeaderBindingImpl;
import com.mooc.fovies.databinding.LayoutTagListItemBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.activity_feed_detail_type_image, LAYOUT_ACTIVITYFEEDDETAILTYPEIMAGE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.activity_layout_capture, LAYOUT_ACTIVITYLAYOUTCAPTURE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.activity_layout_preview, LAYOUT_ACTIVITYLAYOUTPREVIEW);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.activity_layout_profile, LAYOUT_ACTIVITYLAYOUTPROFILE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.activity_layout_publish, LAYOUT_ACTIVITYLAYOUTPUBLISH);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.activity_layout_tag_feed_list, LAYOUT_ACTIVITYLAYOUTTAGFEEDLIST);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.fragment_my, LAYOUT_FRAGMENTMY);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.fragment_sofa, LAYOUT_FRAGMENTSOFA);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_comment_dialog, LAYOUT_LAYOUTCOMMENTDIALOG);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_author, LAYOUT_LAYOUTFEEDAUTHOR);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_comment_list_item, LAYOUT_LAYOUTFEEDCOMMENTLISTITEM);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_detail_author_info, LAYOUT_LAYOUTFEEDDETAILAUTHORINFO);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_detail_bottom_inateraction, LAYOUT_LAYOUTFEEDDETAILBOTTOMINATERACTION);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_detail_type_image_header, LAYOUT_LAYOUTFEEDDETAILTYPEIMAGEHEADER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_detail_type_video, LAYOUT_LAYOUTFEEDDETAILTYPEVIDEO);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_detail_type_video_header, LAYOUT_LAYOUTFEEDDETAILTYPEVIDEOHEADER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_interaction, LAYOUT_LAYOUTFEEDINTERACTION);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_tag, LAYOUT_LAYOUTFEEDTAG);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_text, LAYOUT_LAYOUTFEEDTEXT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_top_comment, LAYOUT_LAYOUTFEEDTOPCOMMENT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_type_comment, LAYOUT_LAYOUTFEEDTYPECOMMENT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_type_image, LAYOUT_LAYOUTFEEDTYPEIMAGE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_feed_type_video, LAYOUT_LAYOUTFEEDTYPEVIDEO);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_profile_tab_comment_interaction, LAYOUT_LAYOUTPROFILETABCOMMENTINTERACTION);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_refresh_view, LAYOUT_LAYOUTREFRESHVIEW);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_tag_feed_list_header, LAYOUT_LAYOUTTAGFEEDLISTHEADER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.mooc.fovies.R.layout.layout_tag_list_item, LAYOUT_LAYOUTTAGLISTITEM);
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      sKeys.put("layout/activity_feed_detail_type_image_0", com.mooc.fovies.R.layout.activity_feed_detail_type_image);
      sKeys.put("layout/activity_layout_capture_0", com.mooc.fovies.R.layout.activity_layout_capture);
      sKeys.put("layout/activity_layout_preview_0", com.mooc.fovies.R.layout.activity_layout_preview);
      sKeys.put("layout/activity_layout_profile_0", com.mooc.fovies.R.layout.activity_layout_profile);
      sKeys.put("layout/activity_layout_publish_0", com.mooc.fovies.R.layout.activity_layout_publish);
      sKeys.put("layout/activity_layout_tag_feed_list_0", com.mooc.fovies.R.layout.activity_layout_tag_feed_list);
      sKeys.put("layout/fragment_my_0", com.mooc.fovies.R.layout.fragment_my);
      sKeys.put("layout/fragment_sofa_0", com.mooc.fovies.R.layout.fragment_sofa);
      sKeys.put("layout/layout_comment_dialog_0", com.mooc.fovies.R.layout.layout_comment_dialog);
      sKeys.put("layout/layout_feed_author_0", com.mooc.fovies.R.layout.layout_feed_author);
      sKeys.put("layout/layout_feed_comment_list_item_0", com.mooc.fovies.R.layout.layout_feed_comment_list_item);
      sKeys.put("layout/layout_feed_detail_author_info_0", com.mooc.fovies.R.layout.layout_feed_detail_author_info);
      sKeys.put("layout/layout_feed_detail_bottom_inateraction_0", com.mooc.fovies.R.layout.layout_feed_detail_bottom_inateraction);
      sKeys.put("layout/layout_feed_detail_type_image_header_0", com.mooc.fovies.R.layout.layout_feed_detail_type_image_header);
      sKeys.put("layout/layout_feed_detail_type_video_0", com.mooc.fovies.R.layout.layout_feed_detail_type_video);
      sKeys.put("layout/layout_feed_detail_type_video_header_0", com.mooc.fovies.R.layout.layout_feed_detail_type_video_header);
      sKeys.put("layout/layout_feed_interaction_0", com.mooc.fovies.R.layout.layout_feed_interaction);
      sKeys.put("layout/layout_feed_tag_0", com.mooc.fovies.R.layout.layout_feed_tag);
      sKeys.put("layout/layout_feed_text_0", com.mooc.fovies.R.layout.layout_feed_text);
      sKeys.put("layout/layout_feed_top_comment_0", com.mooc.fovies.R.layout.layout_feed_top_comment);
      sKeys.put("layout/layout_feed_type_comment_0", com.mooc.fovies.R.layout.layout_feed_type_comment);
      sKeys.put("layout/layout_feed_type_image_0", com.mooc.fovies.R.layout.layout_feed_type_image);
      sKeys.put("layout/layout_feed_type_video_0", com.mooc.fovies.R.layout.layout_feed_type_video);
      sKeys.put("layout/layout_profile_tab_comment_interaction_0", com.mooc.fovies.R.layout.layout_profile_tab_comment_interaction);
      sKeys.put("layout/layout_refresh_view_0", com.mooc.fovies.R.layout.layout_refresh_view);
      sKeys.put("layout/layout_tag_feed_list_header_0", com.mooc.fovies.R.layout.layout_tag_feed_list_header);
      sKeys.put("layout/layout_tag_list_item_0", com.mooc.fovies.R.layout.layout_tag_list_item);
    }
  }
}
