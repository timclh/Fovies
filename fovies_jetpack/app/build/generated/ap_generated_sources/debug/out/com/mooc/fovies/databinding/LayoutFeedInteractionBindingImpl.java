...
public class LayoutFeedInteractionBindingImpl extends LayoutFeedInteractionBinding implements com.mooc.fovies.generated.callback.OnClickListener.Listener {
    ...
    private LayoutFeedInteractionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback13 = new com.mooc.fovies.generated.callback.OnClickListener(this, 3);
        mCallback11 = new com.mooc.fovies.generated.callback.OnClickListener(this, 1);
        mCallback12 = new com.mooc.fovies.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeFeedUgc((com.mooc.fovies.model.Ugc) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeFeedUgc(com.mooc.fovies.model.Ugc FeedUgc, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.mooc.fovies.model.Ugc feedUgc = null;
        ...
        if ((dirtyFlags & 0x400L) != 0) {
                ...
                stringConvertConvertFeedUgcFeedUgcLikeCount = com.mooc.fovies.utils.StringConvert.convertFeedUgc(feedUgcLikeCount);
        }
        if ((dirtyFlags & 0x100L) != 0) {

                // read StringConvert.convertFeedUgc(feed.ugc.commentCount)
                stringConvertConvertFeedUgcFeedUgcCommentCount = com.mooc.fovies.utils.StringConvert.convertFeedUgc(feedUgcCommentCount);
        }
        if ((dirtyFlags & 0x40000L) != 0) {

                // read StringConvert.convertFeedUgc(feed.ugc.shareCount)
                stringConvertConvertFeedUgcFeedUgcShareCount = com.mooc.fovies.utils.StringConvert.convertFeedUgc(feedUgcShareCount);
        }
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            ...
            case 1: {
                ...
                com.mooc.fovies.ui.InteractionPresenter.toggleFeedLike(lifeCycleOwner, feed);
                break;
            }
            case 2: {
                // localize variables for thread safety
                ...
                com.mooc.fovies.ui.InteractionPresenter.toggleFeedDiss(lifeCycleOwner, feed);
                break;
            }
        }
    }
