...
public class ActivityLayoutTagFeedListBindingImpl extends ActivityLayoutTagFeedListBinding implements com.mooc.fovies.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {4},
            new int[] {com.mooc.fovies.R.layout.layout_refresh_view});
    ...
    private ActivityLayoutTagFeedListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (com.mooc.fovies.databinding.LayoutRefreshViewBinding) bindings[4]
        ...
        setRootTag(root);
        // listeners
        mCallback9 = new com.mooc.fovies.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.owner == variableId) {
            ...
            setTagList((com.mooc.fovies.model.TagList) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setTagList(@Nullable com.mooc.fovies.model.TagList TagList) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeRefreshLayout((com.mooc.fovies.databinding.LayoutRefreshViewBinding) object, fieldId);
            case 1 :
                return onChangeTagList((com.mooc.fovies.model.TagList) object, fieldId);
        }
        return false;
    }
    private boolean onChangeRefreshLayout(com.mooc.fovies.databinding.LayoutRefreshViewBinding RefreshLayout, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeTagList(com.mooc.fovies.model.TagList TagList, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.mooc.fovies.model.TagList tagList = mTagList;
        ...
        if ((dirtyFlags & 0x12L) != 0) {
            ...
            com.mooc.fovies.view.PPImageView.setImageUrl(this.tagLogo, tagListIcon, false, 8);
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        com.mooc.fovies.ui.InteractionPresenter.toggleTagLike(owner, tagList);
    }
    // dirty flag
