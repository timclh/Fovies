...
public class FragmentMyBindingImpl extends FragmentMyBinding  {
    ...
    @NonNull
    private final com.mooc.fovies.view.PPImageView mboundView1;
    // variables
    // values
    // listeners
    ...
    private FragmentMyBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.mboundView1 = (com.mooc.fovies.view.PPImageView) bindings[1];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.user == variableId) {
            setUser((com.mooc.fovies.model.User) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUser(@Nullable com.mooc.fovies.model.User User) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeUser((com.mooc.fovies.model.User) object, fieldId);
        }
        return false;
    }
    private boolean onChangeUser(com.mooc.fovies.model.User User, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.mooc.fovies.model.User user = mUser;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                stringConvertConvertSpannableUserLikeCountLikeCountAndroidStringLikeCount = com.mooc.fovies.utils.StringConvert.convertSpannable(userLikeCount, likeCount.getResources().getString(R.string.like_count));
                // read StringConvert.convertSpannable(user.score, @android:string/score_count)
                stringConvertConvertSpannableUserScoreScoreCountAndroidStringScoreCount = com.mooc.fovies.utils.StringConvert.convertSpannable(userScore, scoreCount.getResources().getString(R.string.score_count));
                // read StringConvert.convertSpannable(user.followCount, @android:string/follow_count)
                stringConvertConvertSpannableUserFollowCountFollowCountAndroidStringFollowCount = com.mooc.fovies.utils.StringConvert.convertSpannable(userFollowCount, followCount.getResources().getString(R.string.follow_count));
                // read StringConvert.convertSpannable(user.followerCount, @android:string/fans_count)
                stringConvertConvertSpannableUserFollowerCountFansCountAndroidStringFansCount = com.mooc.fovies.utils.StringConvert.convertSpannable(userFollowerCount, fansCount.getResources().getString(R.string.fans_count));
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1

            com.mooc.fovies.view.PPImageView.setImageUrl(this.avatar, userAvatar, true, 0);
            ...
            com.mooc.fovies.view.PPImageView.setBlurImageUrl(this.mboundView1, userAvatar, 50);
