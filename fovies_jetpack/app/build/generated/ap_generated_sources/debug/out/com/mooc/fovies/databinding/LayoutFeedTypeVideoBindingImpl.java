...
public class LayoutFeedTypeVideoBindingImpl extends LayoutFeedTypeVideoBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {com.mooc.fovies.R.layout.layout_feed_author,
                ...
                com.mooc.fovies.R.layout.layout_feed_top_comment,
                com.mooc.fovies.R.layout.layout_feed_interaction});
    ...
    @Nullable
    private final com.mooc.fovies.databinding.LayoutFeedTopCommentBinding mboundView04;
    // variables
    // values
    // listeners
    ...
    private LayoutFeedTypeVideoBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4
            , (com.mooc.fovies.databinding.LayoutFeedInteractionBinding) bindings[5]
            , (com.mooc.fovies.view.ListPlayerView) bindings[6]
            );
        this.mboundView0 = (com.mooc.fovies.databinding.LayoutFeedAuthorBinding) bindings[1];
        setContainedBinding(this.mboundView0);
        this.mboundView01 = (android.widget.LinearLayout) bindings[0];
        this.mboundView01.setTag(null);
        this.mboundView02 = (com.mooc.fovies.databinding.LayoutFeedTextBinding) bindings[2];
        setContainedBinding(this.mboundView02);
        this.mboundView03 = (com.mooc.fovies.databinding.LayoutFeedTagBinding) bindings[3];
        setContainedBinding(this.mboundView03);
        this.mboundView04 = (com.mooc.fovies.databinding.LayoutFeedTopCommentBinding) bindings[4];
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeInteractionBinding((com.mooc.fovies.databinding.LayoutFeedInteractionBinding) object, fieldId);
            case 1 :
                return onChangeFeed((com.mooc.fovies.model.Feed) object, fieldId);
            case 2 :
                return onChangeFeedAuthor((com.mooc.fovies.model.User) object, fieldId);
            case 3 :
                return onChangeFeedTopComment((com.mooc.fovies.model.Comment) object, fieldId);
        }
        return false;
    }
    private boolean onChangeInteractionBinding(com.mooc.fovies.databinding.LayoutFeedInteractionBinding InteractionBinding, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeFeedAuthor(com.mooc.fovies.model.User FeedAuthor, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        com.mooc.fovies.model.User feedAuthor = null;
