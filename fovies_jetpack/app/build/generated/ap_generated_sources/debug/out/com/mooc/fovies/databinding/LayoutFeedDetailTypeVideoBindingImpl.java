...
public class LayoutFeedDetailTypeVideoBindingImpl extends LayoutFeedDetailTypeVideoBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1, 2, 3},
            new int[] {com.mooc.fovies.R.layout.layout_feed_detail_author_info,
                com.mooc.fovies.R.layout.layout_feed_detail_bottom_inateraction,
                com.mooc.fovies.R.layout.layout_feed_detail_author_info});
    ...
    private LayoutFeedDetailTypeVideoBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4
            ...
            , (com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBinding) bindings[1]
            , (com.mooc.fovies.databinding.LayoutFeedDetailBottomInateractionBinding) bindings[2]
            , (androidx.coordinatorlayout.widget.CoordinatorLayout) bindings[0]
            , (com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBinding) bindings[3]
            , (com.mooc.fovies.view.FullScreenPlayerView) bindings[4]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeFullscreenAuthorInfo((com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBinding) object, fieldId);
            case 1 :
                return onChangeFeed((com.mooc.fovies.model.Feed) object, fieldId);
            case 2 :
                return onChangeBottomInteraction((com.mooc.fovies.databinding.LayoutFeedDetailBottomInateractionBinding) object, fieldId);
            case 3 :
                return onChangeAuthorInfo((com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeFullscreenAuthorInfo(com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBinding FullscreenAuthorInfo, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeBottomInteraction(com.mooc.fovies.databinding.LayoutFeedDetailBottomInateractionBinding BottomInteraction, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    private boolean onChangeAuthorInfo(com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBinding AuthorInfo, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
