...
public class LayoutFeedTypeCommentBindingImpl extends LayoutFeedTypeCommentBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {4, 5, 6, 7},
            new int[] {com.mooc.fovies.R.layout.layout_feed_author,
                com.mooc.fovies.R.layout.layout_feed_text,
                com.mooc.fovies.R.layout.layout_feed_tag,
                com.mooc.fovies.R.layout.layout_profile_tab_comment_interaction});
        sViewsWithIds = null;
    }
    // views
    @Nullable
    private final com.mooc.fovies.databinding.LayoutFeedAuthorBinding mboundView0;
    @NonNull
    private final android.widget.LinearLayout mboundView01;
    @Nullable
    private final com.mooc.fovies.databinding.LayoutFeedTextBinding mboundView02;
    @Nullable
    private final com.mooc.fovies.databinding.LayoutFeedTagBinding mboundView03;
    @NonNull
    ...
    private LayoutFeedTypeCommentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4
            , (com.mooc.fovies.view.PPImageView) bindings[2]
            , (android.widget.ImageView) bindings[3]
            , (com.mooc.fovies.databinding.LayoutProfileTabCommentInteractionBinding) bindings[7]
            );
        this.iconCover.setTag(null);
        this.iconVideo.setTag(null);
        this.mboundView0 = (com.mooc.fovies.databinding.LayoutFeedAuthorBinding) bindings[4];
        setContainedBinding(this.mboundView0);
        this.mboundView01 = (android.widget.LinearLayout) bindings[0];
        this.mboundView01.setTag(null);
        this.mboundView02 = (com.mooc.fovies.databinding.LayoutFeedTextBinding) bindings[5];
        setContainedBinding(this.mboundView02);
        this.mboundView03 = (com.mooc.fovies.databinding.LayoutFeedTagBinding) bindings[6];
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeFeedTopComment((com.mooc.fovies.model.Comment) object, fieldId);
            case 2 :
                return onChangeInteractionBinding((com.mooc.fovies.databinding.LayoutProfileTabCommentInteractionBinding) object, fieldId);
            case 3 :
                return onChangeFeedTopCommentAuthor((com.mooc.fovies.model.User) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeFeedTopComment(com.mooc.fovies.model.Comment FeedTopComment, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeInteractionBinding(com.mooc.fovies.databinding.LayoutProfileTabCommentInteractionBinding InteractionBinding, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    private boolean onChangeFeedTopCommentAuthor(com.mooc.fovies.model.User FeedTopCommentAuthor, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        com.mooc.fovies.model.Comment feedTopComment = null;
        ...
        com.mooc.fovies.model.User feedTopCommentAuthor = null;
        ...
        if ((dirtyFlags & 0x2bL) != 0) {
            ...
            if ((dirtyFlags & 0x21L) != 0) {
                    ...
                    feedItemTypeFeedTYPEVIDEO = (feedItemType) == (com.mooc.fovies.model.Feed.TYPE_VIDEO);
                if((dirtyFlags & 0x21L) != 0) {
        ...
        if ((dirtyFlags & 0x21L) != 0) {
            ...
            com.mooc.fovies.view.PPImageView.setImageUrl(this.iconCover, feedCover, (boolean)false, (int)0);
