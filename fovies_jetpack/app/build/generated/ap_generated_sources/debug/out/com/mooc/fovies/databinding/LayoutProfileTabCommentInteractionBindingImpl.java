...
public class LayoutProfileTabCommentInteractionBindingImpl extends LayoutProfileTabCommentInteractionBinding implements com.mooc.fovies.generated.callback.OnClickListener.Listener {
    ...
    private LayoutProfileTabCommentInteractionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback2 = new com.mooc.fovies.generated.callback.OnClickListener(this, 2);
        mCallback1 = new com.mooc.fovies.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 2 :
                return onChangeFeedTopCommentUgc((com.mooc.fovies.model.Ugc) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeFeedTopCommentUgc(com.mooc.fovies.model.Ugc FeedTopCommentUgc, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        com.mooc.fovies.model.Ugc feedTopCommentUgc = null;
        ...
        if ((dirtyFlags & 0x4000L) != 0) {
                ...
                stringConvertConvertFeedUgcFeedTopCommentUgcShareCount = com.mooc.fovies.utils.StringConvert.convertFeedUgc(feedTopCommentUgcShareCount);
        }
        if ((dirtyFlags & 0x400L) != 0) {

                // read StringConvert.convertFeedUgc(feed.topComment.ugc.likeCount)
                stringConvertConvertFeedUgcFeedTopCommentUgcLikeCount = com.mooc.fovies.utils.StringConvert.convertFeedUgc(feedTopCommentUgcLikeCount);
        }
        if ((dirtyFlags & 0x1000L) != 0) {

                // read StringConvert.convertFeedUgc(feed.topComment.ugc.commentCount)
                stringConvertConvertFeedUgcFeedTopCommentUgcCommentCount = com.mooc.fovies.utils.StringConvert.convertFeedUgc(feedTopCommentUgcCommentCount);
        }
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            case 2: {
                ...
                com.mooc.fovies.ui.InteractionPresenter.openShare(contextLifeCycleOwner, feed);
                break;
            }
            case 1: {
                // localize variables for thread safety
                ...
                if (feedJavaLangObjectNull) {
                    ...
                    com.mooc.fovies.ui.InteractionPresenter.toggleCommentLike(lifeCycleOwner, feedTopComment);
                }
                break;
            }
        }
