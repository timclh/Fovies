...
public class ActivityFeedDetailTypeImageBindingImpl extends ActivityFeedDetailTypeImageBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {3},
            new int[] {com.mooc.fovies.R.layout.layout_feed_detail_bottom_inateraction});
    ...
    private ActivityFeedDetailTypeImageBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            ...
            , (com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBinding) bindings[2]
            , (com.mooc.fovies.databinding.LayoutFeedDetailBottomInateractionBinding) bindings[3]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeAuthorInfoLayout((com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBinding) object, fieldId);
            case 2 :
                return onChangeInteractionLayout((com.mooc.fovies.databinding.LayoutFeedDetailBottomInateractionBinding) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeAuthorInfoLayout(com.mooc.fovies.databinding.LayoutFeedDetailAuthorInfoBinding AuthorInfoLayout, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeInteractionLayout(com.mooc.fovies.databinding.LayoutFeedDetailBottomInateractionBinding InteractionLayout, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
